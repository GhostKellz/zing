#!/bin/bash
# Zing installer for Debian / Ubuntu
# Usage: curl -fsSL https://raw.githubusercontent.com/ghostkellz/zing/main/release/debian/install.sh | bash
...
command -v apt &>/dev/null || error "This installer requires apt (Debian/Ubuntu)"

info "🚀 Zing Installer for Debian / Ubuntu"
echo
